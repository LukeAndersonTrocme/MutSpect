...
def frequency_breakdown(ThisPop,start_chr, end_chr):
...
pops=dict({})
pops['EUR']=['CEU','GBR','FIN','IBS','TSI', 'EUR']
pops['SAS']=['GIH','ITU','PJL','BEB','STU', 'SAS']
pops['EAS']=['CHB','CHS','JPT','KHV','CDX', 'EAS']
pops['AFR']=['YRI','MSL','LWK','ESN','GWD', 'AFR']
pops['AMR']=['CLM','MXL','PUR','PEL','ACB','ASW', 'AMR']
